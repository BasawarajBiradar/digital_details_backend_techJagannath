...
public class UserManagementServiceImpl implements UserManagementService {
    ...
    public UserManagementServiceImpl(RoleMasterRepository roleMasterRepository, UserMasterRepository userMasterRepository,
                                     ChildProfileRepository childProfileRepository, UserProfileNfcMappingRepository userProfileNfcMappingRepository,
                                     ProfileTypesMasterRepository profileTypesMasterRepository, JwtUtil jwtUtil, SeniorProfileRepository seniorProfileRepository,
    ...
    public RegisterCardUserSeniorDetailsResultModel serviceEntryPointForSaveSeniorProfileDetails(HttpServletRequest request, RegisterCardUserSeniorDetailsRequestModel requestModel) {
        ...
        SeniorProfile seniorProfile = new SeniorProfile(null, requestModel.getFullName(),
                requestModel.getGender(), null, null, requestModel.getBloodGroup(), requestModel.getMedicalCondition(),
                user);
    ...
    public RegisterCardUserBusinessDetailsResultModel serviceEntryPointForSaveUserBusinessProfileDetails(HttpServletRequest request, RegisterCardUserBusinessDetailsRequestModel requestModel) {
        ...
        BusinessProfile businessProfile = new BusinessProfile( null,
                requestModel.getBusinessName(), null, requestModel.getOwnerName(), requestModel.getGstNumber(),
                requestModel.getBusinessPhone(), requestModel.getBusinessAddress(), null,
                requestModel.getBusinessEmail(), requestModel.getWebsiteUrl(), user);
    ...
    public RegisterCardUserVehicleDetailsResultModel serviceEntryPointForSaveUserVehicleProfileDetails(HttpServletRequest request, RegisterCardUserVehicleDetailsRequestModel requestModel) {
        ...
        VehicleProfile vehicleProfile = new VehicleProfile( null,
                requestModel.getVehicleNumber(), requestModel.getVehicleType(), requestModel.getBrand(), requestModel.getModel(),
                requestModel.getOwnerName(), requestModel.getOwnerContact(), requestModel.getAlternateContact(), user
        );
    ...
    public RegisterCardUserPetsDetailsResultModel serviceEntryPointForSaveuserPetsProfileDetails(HttpServletRequest request, RegisterCardUserPetsDetailsRequestModel requestModel) {
        ...
        PetProfile petProfile = new PetProfile(null,
                requestModel.getPetName(), requestModel.getSpecies(), requestModel.getOwnerName(), requestModel.getOwnerContact(),
                requestModel.getOwnerAddress(), requestModel.getAlternateContact(), requestModel.getVaccinationStatus(), requestModel.getBreed(), user
        );
